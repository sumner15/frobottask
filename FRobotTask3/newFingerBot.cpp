...
FingerBot::FingerBot() : XPCModel()  // config removed
{
}

void FingerBot::config(std::string ipAddress, std::string ipPort, std::string mdlName)  // djm added
{	

	xpc.config( ipAddress, ipPort, mdlName);
	
	std::cout << "Bot Loaded " << std::endl;
